module.exports = {
    ...
    execute(message, args) {
        ...
        if (!commandName) {
            return message.reply(`To get detailed information about a specific command, use the following format:
=>help <commandName>
...
- *unixporn*: Send a random image of a fully Riced Desktop
        ...
        const commandHelp = {
            menu: `*menu*: Displays a list of all available commands.
Usage: =>menu
This command shows you all the commands you can use in the bot.`,
            help: `*help*: Provides detailed information about specific commands.
Usage: =>help <commandName>
Use this command to get detailed help for a specific command.
Example: =>help menu`,
            stickers: `*stickers*: Convert images or videos to stickers.
Usage: =>stickers
...
This command gives a random chess position, and you have to bet on its evaluation by tagging the evaluation with the bet amount in a subsequent bot message.`,
            betwinner: `*betWinner*: Bet on the result of the current game.
...
Example: =>betWinner gukesh 100`,
            nextmovebet: `*nextMoveBet*: Bet on the next move of the current game.
...
Example: =>nextMoveBet e4 50`,
            evalbet: `*evalBet*: Bet on the evaluation of the current game.
